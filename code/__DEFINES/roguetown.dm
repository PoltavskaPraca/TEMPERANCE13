...
#define ALL_INHUMAN_PATRONS list(/datum/patron/inhuman/zizo, /datum/patron/inhuman/graggar, /datum/patron/inhuman/matthios, /datum/patron/inhuman/baotha)

#define NON_PSYDON_PATRONS list(/datum/patron/divine/astrata, /datum/patron/divine/noc, /datum/patron/divine/dendor, /datum/patron/divine/abyssor, /datum/patron/divine/ravox, /datum/patron/divine/necra, /datum/patron/divine/xylix, /datum/patron/divine/pestra, /datum/patron/divine/malum, /datum/patron/divine/eora, /datum/patron/inhuman/zizo, /datum/patron/inhuman/graggar, /datum/patron/inhuman/matthios, /datum/patron/inhuman/baotha)	//For lord/heir usage
