/datum/job/roguetown/risvonconscript
	...
	outfit = /datum/outfit/job/roguetown/risvonconscript
	display_order = JDO_RISVONCONSCRIPT
...
/datum/job/roguetown/risvonconscript/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	..()
	if(ishuman(L))
...
/datum/outfit/job/roguetown/risvonconscript/pre_equip(mob/living/carbon/human/H)
